...
export class CreateUsers1778706060726 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "withdrawals" ADD CONSTRAINT "FK_withdrawals_user_id" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "withdrawal_addresses" ADD CONSTRAINT "FK_withdrawal_addresses_user_id" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "withdrawal_addresses" DROP CONSTRAINT "FK_withdrawal_addresses_user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "withdrawals" DROP CONSTRAINT "FK_withdrawals_user_id"`,
    );
    await queryRunner.query(
